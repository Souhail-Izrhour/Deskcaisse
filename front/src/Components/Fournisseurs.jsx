        ...
        <div className="bg-white rounded-xl sm:rounded-2xl shadow-sm p-4 sm:p-6 mb-2 sm:mb-3">
          <div className="flex flex-col space-y-4 sm:space-y-0 sm:flex-row sm:items-center sm:justify-between">
            <div className="text-center sm:text-left">
              <h1 className="text-xl sm:text-2xl md:text-3xl font-bold text-gray-900">Gestion des Fournisseurs</h1>
              <p className="text-gray-600 mt-1 sm:mt-2 text-sm sm:text-base">Gérez vos partenaires fournisseurs</p>
            </div>
            <button
            ...
            >
              <HiOutlineTruck className="w-4 h-4 sm:w-5 sm:h-5 mr-2" />
