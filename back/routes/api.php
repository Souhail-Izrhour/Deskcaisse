 ...
 Route::middleware(IsSuper::class)->group(function () {
   ...
   Route::middleware(CheckTenant::class)->group(function () {
    ...
    // Routes Shift
            ...
            Route::post('/shifts/{shift}/print', [ShiftController::class, 'printShift']);            Route::get('/shifts/hasActiveShift', [ShiftController::class, 'hasActiveShift']); // Vérifier s'il y a un shift actif
